...
11. [Living World Landing](#living-world-landing)
12. [Dashboard Metrics](#dashboard-metrics)
13. [Mixed Product Section](#mixed-product-section)
14. [Category CSS Strategy](#category-css-strategy)
15. [Full Stylesheet Strategy](#full-stylesheet-strategy)
16. [TypeScript Example](#typescript-example)
17. [Vite Example](#vite-example)
18. [Next.js Client Component Example](#nextjs-client-component-example)
...
export function LivingWorldLandingExample() {
  return (
    <LivingWorldLanding
      eyebrow="BUILT FOR MODERN PRODUCTS"
      title="Build digital experiences that feel alive."
      description="A cinematic landing page for SaaS products, AI platforms, creative tools, and modern product teams."
      ...
      onSecondaryClick={() => {
        console.log("Explore components");
      }}
    />
  );
}
...
Use when you want a cinematic, modern landing-page composition for SaaS, AI, creative, or product experiences.
